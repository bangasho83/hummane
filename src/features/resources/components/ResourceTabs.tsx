...
import { BarChart3, ClipboardList, Package, ReceiptText, Shapes } from 'lucide-react'
        ...
        <div className="flex flex-wrap gap-2">
            {tabs.map((tab) => {
                const active = tab.exact
                    ? pathname === tab.href || (pathname.startsWith('/resources/') && !pathname.startsWith('/resources/assets') && !pathname.startsWith('/resources/bills') && !pathname.startsWith('/resources/templates') && !pathname.startsWith('/resources/reports'))

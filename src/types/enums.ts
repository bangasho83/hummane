...
export const EMPLOYMENT_TYPES = ['Contract', 'Full-time', 'Intern', 'Part-time'] as const
...
export const APPLICANT_STATUSES = ['new', 'screening', 'interview', 'offer', 'rejected', 'hired'] as const
